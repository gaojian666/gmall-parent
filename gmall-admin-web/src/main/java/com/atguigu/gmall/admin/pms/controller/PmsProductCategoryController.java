...
public class PmsProductCategoryController {
    ...
    public Object getList(@PathVariable Long parentId,
        ...
        // 分页查询商品分类
        Map<String,Object> map = productCategoryService.getPageList(parentId,pageNum,pageSize);
    ...
    public Object getItem(@PathVariable Long id) {
        // 根据id获取商品分类
        ProductCategory productCategory = productCategoryService.getProductById(id);
    ...
    public Object listWithChildren() {
        // 查询所有一级分类及子分类
        List<LevelOneCategoryVO> list = productCategoryService.getList();
